document.addEventListener("DOMContentLoaded", () => {
      ...
      reader.onload = (e) => {
        ...
        if (fileType === "json") {
          try {
            ...
            alert(
              'Ganti nama file menjadi "followers" dan unggah file JSON yang valid.'
            );
            followersData = [];
          }
      ...
      reader.onload = (e) => {
        ...
        if (fileType === "json") {
          try {
            ...
            alert(
              'Ganti nama file menjadi "following" dan unggah file JSON yang valid.'
            );
            followingData = [];
          }
        } else if (fileType === "html") {
  ...
  function displayResult(notFollowingBack) {
    ...
    if (notFollowingBack.length === 0) {
      resultTableBody.innerHTML =
        '<tr><td colspan="3" style="text-align: center;">No unfollowers found.</td></tr>';
      return;
    }
